...
<body>
	...
	<div id="header_gt1080">
		<h2>Unfortunately, this site doesn't respond well to monitor resolutions over 1080 pixels tall. Please resize your browser smaller/use a different device and refresh the page. MUDS A BIHHHHHHH</h2>
	</div>
	...
	<footer>
		...
		<p>
		I wanted to stream myself playing a game I like. Yay! But I personally despise panhandling for other people's attention without reciprocating in some way. So I spent the last two weeks optimizing my stream setup.<br><br>
		
		What started as a simple stream UI design quickly snowballed into getting the copious rust that'd accumulated off my web dev'ing background. 
		</p>
		...
		<h4 id="pc619" style="text-align: center;" onclick="dopeAudio('audio/byzantine.mp3')">pc619</h4>
	</footer>
